...
void syst_ntag_3(){
  ...
  float frac_nom = par0+exp(par1*0.252+par2);
  float frac_down = par0+exp(par1*0.237+par2);
  float frac_up = par0+exp(par1*0.267+par2);
  ...
  cout << "bkg frac for eff 25.2% is " << frac_nom << endl;
  cout << "bkg frac for eff 23.7% is " << frac_down << endl;
  cout << "bkg frac for eff 26.7% is " << frac_up << endl;
