...
void syst_decaye_2(){
  ...
  TH1* hist_mc = (TH1*) input_mc->Get("n_michel_electron_mulike1");
  TH1* hist_data = (TH1*) input_data->Get("n_michel_electron_mulike1");
  ...
  c1->SaveAs(Form("hist/compare_data_mc_n_michel_electron_mulike1_%s.pdf",mode.c_str()));
  ...
  c2->SaveAs(Form("hist/compare_data_mc_n_michel_electron_mulike1_scaled_%s.pdf",mode.c_str()));
