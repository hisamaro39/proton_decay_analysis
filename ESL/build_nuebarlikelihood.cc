...
int main( int argc, char * argv[] )
{
   ...
   ss.str(""); ss << "output_nuebarlikelihood" ;
   ...
   std::string mmefile;
   ss.str(""); ss << "input_mgmreLikelihood" ;
   MasterCard->GetKey( ss.str().c_str() ,  mmefile );
   nuebarLikelihood * llnuebar = new nuebarLikelihood( dm , skgen, mmefile.c_str()  );
